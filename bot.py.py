...
SERVICES_TEXT = (
    "📚 *Услуги Zaur Academy*\n\n"
    "• Курсы программирования (Python, JavaScript, и др.)\n"
    "• Индивидуальные занятия с преподавателем\n"
    "• Подготовка к собеседованиям и карьерный коучинг\n"
...
PRICES_TEXT = (
    ...
    "Уточнить актуальные цены можно у нашего менеджера."
)

CONTACTS_TEXT = (
    "📬 *Контакты Zaur Academy*\n\n"
    "🌐 Сайт: [zауr.academy](https://t.me)\n"
    "📧 Email: info@zaur.academy\n"
    "📞 Телефон: +7 (999) 123-45-67\n"
    "💬 Telegram-менеджер: @zaur\\_academy\n\n"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    welcome = (
        ...
        "Мы помогаем людям освоить программирование и построить карьеру в IT.\n\n"
